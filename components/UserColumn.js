...
export default function UserColumn(userInfo) {
  return (
    <tr className='border-dotted border-t-2 border-light-blue-100 x'>
      ...
      <td className="text-left w-60 w-2/4"><a href={userInfo.githubURL}><b className='text-gray-800 dark:text-gray-200  hover:text-gray-600  '>{userInfo.githubUsername.length > 16 ? `${userInfo.githubUsername.substring(0,16)}..` : userInfo.githubUsername}</b>
